...
def binary_search_depth(est,mesh, rgb, mask, K, depth_min=0.5, depth_max=2,w=640, h=480, debug=False, ycb=False, depth_input=None):
    low=depth_min
    high=depth_max
    last_depth=np.inf
    while low <= high:
        ...
        pose= est.register(K, rgb, depth_zero, mask, 5, rough_depth_guess=depth_gueess)
